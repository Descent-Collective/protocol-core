...
export interface NGNXInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface NGNX extends BaseContract {
  connect(runner?: ContractRunner | null): NGNX;
  waitForDeployment(): Promise<this>;

  interface: NGNXInterface;
